...
int main() {
    ...
    ([&]() -> HulkValue { auto __env0 = std::make_shared<Environment>(env); __env0->define("arr", ([&]() -> HulkValue { auto __arr = std::make_shared<HulkArray>(); __arr->values.clear(); std::vector<HulkValue> __dims = {HulkValue(static_cast<double>(5))}; size_t __size = 1; for (auto& __d : __dims) { if (std::holds_alternative<std::nullptr_t>(__d)) continue; __size *= static_cast<size_t>(asNum(__d)); } for (size_t __i = 0; __i < __size; ++__i) __arr->values.push_back(HulkValue(nullptr)); return HulkValue(__arr); })()); return ([&]() -> HulkValue { ([&]() -> HulkValue { auto __env1 = std::make_shared<Environment>(__env0); __env1->define("i", HulkValue(static_cast<double>(0))); return ([&]() -> HulkValue { auto __env2 = std::make_shared<Environment>(__env1); HulkValue __r3 = nullptr; while (isTruthy(hLt(__env2->get("i"), HulkValue(static_cast<double>(5))))) { __r3 = ([&]() -> HulkValue { ([&]() -> HulkValue { HulkValue __v4 = hMul(__env2->get("i"), __env2->get("i")); arraySet(__env2->get("arr"), __env2->get("i"), __v4); return __v4; })(); return ([&]() -> HulkValue { HulkValue __v5 = hAdd(__env2->get("i"), HulkValue(static_cast<double>(1))); __env2->assign("i", __v5); return __v5; })(); })(); } return __r3; })(); })(); (isTruthy(hEq(arrayGet(__env0->get("arr"), HulkValue(static_cast<double>(0))), HulkValue(static_cast<double>(0)))) ? (([&]() -> HulkValue { HulkValue __v7 = (HulkValue(std::string("ok"))); std::cout << stringify(__v7) << std::endl; return __v7; })()) : (([&]() -> HulkValue { HulkValue __v6 = (HulkValue(std::string("fail"))); std::cout << stringify(__v6) << std::endl; return __v6; })())); (isTruthy(hEq(arrayGet(__env0->get("arr"), HulkValue(static_cast<double>(1))), HulkValue(static_cast<double>(1)))) ? (([&]() -> HulkValue { HulkValue __v9 = (HulkValue(std::string("ok"))); std::cout << stringify(__v9) << std::endl; return __v9; })()) : (([&]() -> HulkValue { HulkValue __v8 = (HulkValue(std::string("fail"))); std::cout << stringify(__v8) << std::endl; return __v8; })())); (isTruthy(hEq(arrayGet(__env0->get("arr"), HulkValue(static_cast<double>(2))), HulkValue(static_cast<double>(4)))) ? (([&]() -> HulkValue { HulkValue __v11 = (HulkValue(std::string("ok"))); std::cout << stringify(__v11) << std::endl; return __v11; })()) : (([&]() -> HulkValue { HulkValue __v10 = (HulkValue(std::string("fail"))); std::cout << stringify(__v10) << std::endl; return __v10; })())); (isTruthy(hEq(arrayGet(__env0->get("arr"), HulkValue(static_cast<double>(3))), HulkValue(static_cast<double>(9)))) ? (([&]() -> HulkValue { HulkValue __v13 = (HulkValue(std::string("ok"))); std::cout << stringify(__v13) << std::endl; return __v13; })()) : (([&]() -> HulkValue { HulkValue __v12 = (HulkValue(std::string("fail"))); std::cout << stringify(__v12) << std::endl; return __v12; })())); return (isTruthy(hEq(arrayGet(__env0->get("arr"), HulkValue(static_cast<double>(4))), HulkValue(static_cast<double>(16)))) ? (([&]() -> HulkValue { HulkValue __v15 = (HulkValue(std::string("ok"))); std::cout << stringify(__v15) << std::endl; return __v15; })()) : (([&]() -> HulkValue { HulkValue __v14 = (HulkValue(std::string("fail"))); std::cout << stringify(__v14) << std::endl; return __v14; })())); })(); })();
    return 0;
}
