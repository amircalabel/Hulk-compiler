...
// GetExpr
// ============================================================
GetExpr::GetExpr(std::unique_ptr<Expr> object, Token name)
    : object(std::move(object)), name(name) {}

std::variant<double, std::string, bool, std::nullptr_t> GetExpr::accept(ExprVisitor& visitor) const {
...
std::variant<double, std::string, bool, std::nullptr_t> SetExpr::accept(ExprVisitor& visitor) const {
...
// SelfExpr
// ============================================================
SelfExpr::SelfExpr(Token keyword)
    : keyword(keyword) {}

std::variant<double, std::string, bool, std::nullptr_t> SelfExpr::accept(ExprVisitor& visitor) const {
